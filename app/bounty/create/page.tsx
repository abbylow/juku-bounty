      ...
      <div className="space-y-6">
        <div className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            Raise a request in the public to get feedback from other contributors. Current transaction rate is 1% of the bounty amount. Current referral rate is 20% of the reward.
          </p>
        </div>
        <BountyCreationForm />
      </div>
